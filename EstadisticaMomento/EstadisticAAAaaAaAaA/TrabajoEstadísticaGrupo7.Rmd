...
Primeramente, se compararán los 'tags' con el año de salida para encontrar los más frecuentes según el paso del tiempo. Se continuarça analizando los distintas 'tags' con el tiempo de duración de cada juego. Una vez habiendo terminado el análisis de los 'tags', se estudiará cómo los años han afectado a las críticas oficiales y si los jugadores están de acuerdo con estas puntuaciones.
...
### Análisis de 'tags' y 'metacritic_rating'
...
ggplot(datos_separados %>% filter(tags %in% tags_comunes), 
       aes(x = metacritic_rating)) +  # Eje x es el metacritic_rating
  geom_boxplot() +
