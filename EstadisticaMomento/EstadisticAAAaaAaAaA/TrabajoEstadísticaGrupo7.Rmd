...
### 4.1.1  Variable 'extra_content_length'
...
### 4.1.3. Variable 'metacritic_rating'
```{r}
...
### 4.1.4.Variable 'reviewer_rating'
```{r}
...
### 4.1.5.Variable 'positivity_ratio'
...
# Definir intervalos
Tiempo <- cut(datos_limpios$to_beat_main, breaks = 600)  # Definimos intervalos
...
### 4.1.8.Variable 'to_beat_completionist'
```{r}
...
```{r}
cor_reviewer_main <- cor(datos$metacritic_rating, datos$to_beat_main, use = "complete.obs")
cor_reviewer_main

```
Posteriormente se analizaran en detalle qué significa cada resultado.
