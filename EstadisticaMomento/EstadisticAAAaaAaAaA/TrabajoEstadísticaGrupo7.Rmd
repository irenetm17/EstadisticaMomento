...
### 4.1.4.Variable 'positivity_ratio'
```{r}
...
### 4.1.7.Variable 'to_beat_completionist'
```{r}
# Crea una tabla de frecuencias
...
### 4.1.8. Variable 'extra_content_length'
