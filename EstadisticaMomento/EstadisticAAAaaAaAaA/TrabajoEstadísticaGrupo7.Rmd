...
# Introducción y definición de objetivos
Ahora se realizara una comparativa entre los 25 tags mas frecuentes y los diferentes tiempos (Para completar la historia principal, el extra, y todos los objetivos del juego)
```{r}
...
ggplot(datos, aes(x = factor(tags_freq), y = to_beat_main)) + 
  geom_boxplot() +
  labs(x = "Tags mas frecuentes", y = "To Beat Main", title = "Boxplot de To Beat Mian por Tags mas frecuentes") +
  theme_minimal()
