...
# Muestra del dataset
Para comprobar que la importación de datos es correcta se han extraido las 10 primeras filas del dataframe al que hemos llamado "datos".

```{r}
#se extraen las 10 primeras filas
datos |>  slice_head(n=10) |> 
#se crea la tabla 
  gt()
```
