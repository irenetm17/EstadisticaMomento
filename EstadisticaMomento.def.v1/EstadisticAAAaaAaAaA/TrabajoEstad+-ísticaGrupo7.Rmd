...
Representando cada punto en las gráficas un juego del tag seleccionado y siendo analizado en términos de tiempo y su puntuación por expertos, podemos observar que, aunque hay mucha dispersión en todas, se puede ver una tendencia positiva. Esto sugiere que los juegos que requieren más horas tienden a tener una puntuación ligeramente más alta. Gracias a las fórmulas de las pendientes, podemos afirmar que la pendiente más baja se corresponde con el tag 'Early Access', siendo 0.12, lo que indica que el impacto del tiempo sobre la puntuación es el más pequeño de las 15 gráficas. La pendiente más pronunciada es de 0.33 en el tag 'Puzzle', lo que sugiere que el tiempo de juego tiene un ligero impacto en la puntuación en comparación con el resto de los tags. Además, esta relación tiene sentido si se toma en cuenta el tipo de tag. A pesar de esto, podemos concluir que las relaciones son débiles y que, en general, el tiempo no impacta significativamente la puntuación del juego.
